...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-3">
      ...
      <span class="rounded-full px-2.5 py-1 text-[9px] font-black uppercase tracking-[0.12em]" :class="annonce.est_active ? 'bg-[#ecfdf5] text-[#16a34a]' : 'bg-[#f8fafc] text-[#64748b]'">
