...
<template>
  <section class="mt-6">
    <AppModuleHeader badge="Gestion coach" titre="Convocations" description="Selectionnez une equipe puis un evenement pour voir les joueurs convoques et leur reponse.">
      <div class="mx-auto mt-5 max-w-2xl space-y-3">
        <select :value="equipeId" class="h-11 w-full rounded-2xl border border-[#dbe2ef] bg-white px-4 text-sm font-semibold text-[#1f2a44] outline-none focus:border-[#4c6fff]" @change="emit('update:equipeId', $event.target.value)">
